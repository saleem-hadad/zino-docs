...
> {primary} You can select the internal bandgab (1.1 v) as the positive terminal (D6) and use the navigate terminal as your input to compare. However, if you don't want to use the internal bandgab, you have to supply the voltage (0-5 v) reference on pin D6.
